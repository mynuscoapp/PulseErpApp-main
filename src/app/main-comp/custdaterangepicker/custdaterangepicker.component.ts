...
@Component({
  selector: 'app-custdaterangepicker',
  imports: [],
  templateUrl: './custdaterangepicker.component.html',
  styleUrl: './custdaterangepicker.component.scss'
})
export class CustdaterangepickerComponent {
